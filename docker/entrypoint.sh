...
for dir in /home/runner/.npm /home/runner/pw-browsers /home/runner/.local/state/run_hook_tests; do
...
# (workflows use NPM_CONFIG_CACHE for workspace-local cache, so this has no performance impact)
